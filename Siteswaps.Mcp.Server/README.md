...
- `pattern` (string, optional): Pattern (komma-separiert, z.B. "3,3,1", benötigt numberOfJugglers). Unterstützt negative Zahlen: -1 (empty/egal), -2 (any pass/P), -3 (any self/S)
...
GenerateSiteswaps(period: 5, numberOfObjects: 5, minHeight: 2, maxHeight: 10, pattern: "3,-1,1", numberOfJugglers: 2)
GenerateSiteswaps(period: 5, numberOfObjects: 5, minHeight: 2, maxHeight: 10, pattern: "3,3,1", patternRotation: "local", numberOfJugglers: 2)
GenerateSiteswaps(period: 5, numberOfObjects: 5, minHeight: 2, maxHeight: 10, pattern: "3,-2,1", patternRotation: "0", numberOfJugglers: 2)
```
