...
public class FilterDslResources
{
    ...
    [McpServerResource]
    [Description("filter:dsl:function:symmetric")]
    public string FilterDslFunctionSymmetric() =>
        """
        symmetric
        
        Filters for symmetric siteswaps.
        
        No parameters.
        
        A symmetric siteswap has the same throw sequence in both directions 
        or has rotational symmetry.
        
        Examples:
        - symmetric - only symmetric patterns
        
        Use case: Find patterns with aesthetic symmetry.
        """;
