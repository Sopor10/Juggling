...
internal record FilterBuilder : IFilterBuilder
{
    ...
    public IFilterBuilder FlexiblePattern(List<List<int>> pattern, int numberOfJuggler)
    {
        return this with
        {
            Filter = Filter.Add(Factory.FlexiblePatternFilter(pattern, numberOfJuggler))
        };
    }
