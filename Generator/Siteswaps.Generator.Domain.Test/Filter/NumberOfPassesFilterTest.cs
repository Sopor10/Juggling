...
public class NumberOfPassesFilterTest
{
    ...
    {
        var sut = new FilterFactory(new SiteswapGeneratorInput(3, 3, 0, 10)).ExactNumberOfPassesFilter(1, numberOfJugglers);
        var result = sut.CanFulfill(new PartialSiteswap(siteswap));
    ...
    {
        var sut = new FilterFactory(new SiteswapGeneratorInput(3, 3, 0, 5)).ExactNumberOfPassesFilter(1, numberOfJugglers);
